function DisciplinaInfos({ course }) {
    return (
        <div className="bg-primary-50 p-1 z-10 m-1 rounded-lg">
            <h1 className="text-2xl text-primary-700 font-bold mb-6 pb-2">
                Ementa da Disciplina
            </h1>

            <div className="grid grid-cols-3 gap-6 mb-6 bg-primary-100 border-2 py-3">
                <div className>
                ...
                <div>
                    <strong className="text-sm text-primary-600 block">Carga Horária Total(CH):</strong>
            ...
            <div className="mb-6 pt-4 border-t-2 text-left">
                ...
                <p className="text-base text-primary-700 mt-2 text-justify">{course.ementa}</p>
            </div>

            <div className="mb-6 text-left">
                <strong className="text-xl text-primary-600">Objetivos:</strong>
                    <p className="text-base text-primary-700 mt-2 text-justify">{course.objetivos}</p>
            </div>

            <div className="mb-6 text-left">
                <strong className="text-xl text-primary-600">Conteúdo:</strong>
                {course.conteudo.split('\n').map((item, i) => (
                    <p className="text-base text-primary-700 mt-2 text-justify" key={i}>{item}</p>
                ))}
            </div>

            <div className="mb-2 text-left border-b-2 pb-2">
