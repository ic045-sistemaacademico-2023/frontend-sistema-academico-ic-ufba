                    ...
                    <div className='div-login'>
                        ...
                        {exibirErroCpf && (
                            <div className="tela-erro">
                                <div className="erro-conteudo">
                                    ...
                                    <p>Verifique se o CPF que você digitou está correto e tente novamente.</p>
                        ...
                        {exibirErroSenha && (
                            <div className="tela-erro">
                                <div className="erro-conteudo">
                                    ...
                                    <p>Se você esqueceu a senha, clique em ok e depois em "Esqueceu a senha?"</p>
                        ...
                        {exibirErroCpfVazio && (
                            <div className="tela-erro">
                                <div className="erro-conteudo">
                                    <h2>Atenção!</h2>
                                    <p>Você não digitou seu CPF, para efetuar o login é necessário digitar o CPF e a senha</p>
                                    <p>Tente novamente</p>
                        ...
                        {exibirErroEmail && (
                            <div className="tela-erro">
                                <div className="erro-conteudo">
                                    <h2>Atenção!</h2>
                                    <p>Você está tentando recuperar a senha com um e-mail inválido</p>
                                    <p>Verifique se o e-mail que você digitou está correto e tente novamente.</p>
                                    <p>Caso não lembre do e-mail de recuperação, compareça ao colegiado</p>
                        ...
                        {exibirErroEmailVazio && (
                            <div className="tela-erro">
                                <div className="erro-conteudo">
                                    <h2>Atenção!</h2>
                                    <p>Você não digitou seu e-mail, para recuperar a senha é necessário digitar o e-mail</p>
                                    <p>Tente novamente</p>
                                    <Botao onClick={() => setExibirErroEmailVazio(false)}>Ok</Botao>
                                </div>
                            </div>
                        )}
                        ...
                        <p className='esquecer-senha' onClick={esquecido}>Esqueceu a senha?</p>
                        {abrirMenu && <div className='recuperarSenha'>
                            <form>
                                <CampoEmail
                                    email={email}
