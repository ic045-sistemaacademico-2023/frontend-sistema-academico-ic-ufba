                                    ...
                                    <table className="w-full text-sm text-left text-gray-700">
                                        ...
                                        <tbody>
                                            {subjectClasses.turmas.map((subjectClass, index) => (
                                                ...
                                                >
                                                    <td className="px-6 py-4 h-full">{subjectClass.code}</td>
                                                    <td className="px-6 py-4 h-full">{subjectClass.professor.nome}</td>
                                                    <td className="px-6 py-4 h-full">{subjectClass.local}</td>
                                                    <td className="px-6 py-4 h-full">{`${subjectClass.dias} / ${subjectClass.horario}`}</td>
                                                    <td className="px-6 py-4 h-full">
                                                        <div className="flex flex-wrap justify-center items-center gap-2">
                                                            <Button
                                                                onClick={() => navigate(`/turma/${subjectClass.id}`)}
                                                            >
                                                                Visualizar
                                                            </Button>
